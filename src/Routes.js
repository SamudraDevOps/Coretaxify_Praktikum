...
export const RoutesApi = {
  ...
  // Helper nested
  getGroupAssignmentMembers: (groupId, assignmentId) => RoutesApi.lecturer.groups.nested(groupId, "assignments").nested(assignmentId, "members").index(),

  getGroupAssignmentMembers: (groupId, assignmentId) => RoutesApi.lecturer.groups.nested(groupId, "assignments").nested(assignmentId, "members").show(memberId),

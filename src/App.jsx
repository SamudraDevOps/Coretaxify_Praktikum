...
import Bupot26ViewPDF from "./components/PraktikumPage/Badan/BUPOT/Bupot26ViewPDF";
  ...
  return loading ? (
    ...
    <Router>
      <Routes>
        ...
        />
        <Route
          path="/praktikum/:id/sistem/:akun/lihat-konsep-spt/:idSpt"
          // path="/admin/praktikum/2/surat-pemberitahuan-(spt)"
          element={
            <>
              <RoleBasedRenderer
          ...
          element={
            <>
              <RoleBasedRenderer
                ...
                query={"pdf-bp26"}
                OrangPribadi={Bupot26ViewPDF}
                Badan={Bupot26ViewPDF}
              ></RoleBasedRenderer>
            </>
          }
        />

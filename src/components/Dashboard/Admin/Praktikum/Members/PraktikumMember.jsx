...
const PraktikumMember = () => {
  ...
  const [url, setUrl] = useState(
    `${RoutesApi.admin.assignments.url}/${assignmentId}/members`
  );
  ...
  const { data: assignmentData } = useQuery({
    ...
    queryFn: async () => {
      const { data } = await axios.get(
        `${RoutesApi.admin.assignments.url}/${assignmentId}`,
        {
          headers: {
...
export default PraktikumMember;

...
const EditPopupDosen = ({ isOpen, onClose, dosen, onSave }) => {
          ...
          const handleSave = () => {
                    if (formData.namaDosen && formData.instansi && formData.kuotaKelas && formData.status) {
                              ...
                              <div className="edit-popup-content-dosen">
                                        ...
                                        <form>
                                                  <div className="edit-form-group-dosen">
                                                            ...
                                                            <input type="text" name="namaDosen" value={formData.namaDosen} onChange={handleChange} required />
                                                  </div>
                                                  <div className="edit-form-group-dosen">
                                                  ...
                                                  <div className="edit-form-group-dosen">
                                                            ...
                                                            <input type="number" name="kuotaKelas" value={formData.kuotaKelas} onChange={handleChange} required />
                                                  </div>
                                                  <div className="edit-form-group-dosen">
                                                            <label>Kode Registrasi:</label>
                                                            <input type="text" name="kodeRegistrasi" value={formData.kodeRegistrasi} onChange={handleChange} />
                                                  </div>
                                                  <div className="edit-form-group-dosen">
                                                            <label>Jumlah Siswa:</label>
                                                            <input type="number" name="jumlahSiswa" value={formData.jumlahSiswa} onChange={handleChange} />
                                                  </div>
                                                  <div className="edit-form-group-dosen">
                                                            <label>Kode Pembelian:</label>
                                                            <input type="text" name="kodePembelian" value={formData.kodePembelian} onChange={handleChange} />
                                                  </div>
                                                  <div className="edit-form-group-dosen">
                                                            <label>Status:</label>

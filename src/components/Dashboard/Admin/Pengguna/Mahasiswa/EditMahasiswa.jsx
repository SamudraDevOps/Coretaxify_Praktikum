...
const EditMahasiswa = () => {
  ...
  const { isLoading, isError, data, error, isFetching } = getMahasiswa(apiUrl, getCookie());
      ...
      <div className="">
        <div className="kontrak-container">
          <div className="header">
            <h2>Data Mahasiswa {isFetching && <ClipLoader color="#7502B5" size={20} />}</h2>
              ...
              {data?.meta && (
                <>
                  <div className="pagination">
                    <button onClick={() => setCurrentPage(currentPage - 1)} disabled={!data.links.prev}> &lt; </button>
                    ...
                    <button onClick={() => setCurrentPage(currentPage + 1)} disabled={!data.links.next}> &gt; </button>

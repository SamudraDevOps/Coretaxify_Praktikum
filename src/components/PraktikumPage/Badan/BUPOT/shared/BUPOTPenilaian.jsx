...
import { useBupotScore } from "@/hooks/bupot/useBupotScore";
import Swal from "sweetalert2";

const BupotPenilaian = ({ statusPenerbitan, tipeBupot, sistemId }) => {
  ...
  const {
    ...
    isCreating,
    isUpdating,
  } = useBupotScore(cookies, id, akun, statusPenerbitan, sistemId, tipeBupot);

  useEffect(() => {
    if (sistemId && tipeBupot) {
      fetchScore();
    }
  }, [userId, sistemId, tipeBupot]);

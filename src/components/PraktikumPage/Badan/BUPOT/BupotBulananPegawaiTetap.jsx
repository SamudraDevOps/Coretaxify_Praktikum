...
const BupotBulananPegawaiTetap = () => {
    ...
    const menuItems = [
        { label: "Belum Terbit", path: `/admin/praktikum/${userTypeId}/bukti-pemotongan-bulanan-pegawai-tetap` },
        { label: "Telah Terbit", path: `/admin/praktikum/${userTypeId}/bupot/bulanan/pegawai-tetap/telah-terbit` },
        { label: "Tidak Valid", path: `/admin/praktikum/${userTypeId}/bupot/bulanan/pegawai-tetap/tidak-valid` },
    ];

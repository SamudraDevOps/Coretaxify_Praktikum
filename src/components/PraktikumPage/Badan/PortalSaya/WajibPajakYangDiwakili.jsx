...
const WajibPajakYangDiwakiliBadan = () => {
    return (
            ...
            <div className='flex-auto p-3 bg-white rounded-md h-full'>
                <div className='flex justify-between items-center mb-4 pb-3 border-b'>
                    <div className='flex items-center'>
                        ...
                        <h1 className='text-lg font-bold text-blue-900 ml-2'>Wajib Pajak Yang Diwakili</h1>
                    </div>
                </div>
...
export default WajibPajakYangDiwakiliBadan;

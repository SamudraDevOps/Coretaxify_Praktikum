...
export function hitungSubtotal4300(rows) {
  ...
  const kode4001 = rows.find((r) => r.kodeAkun === "4001");
...
export function hitungTotal4600(rows) {
  ...
  if (kode4600 && kode4501 && kode4511 && kode4599) {
    const kolomJumlah = ["nilaiKomersial", "nilaiFiskal"];
    kolomJumlah.forEach((key) => {
      kode4600[key] = toNumber(kode4501[key]) + toNumber(kode4511[key]) + toNumber(kode4599[key]);
    });
  }
}
...
export function hitungTotal4800(rows) {
  ...
  const kode5324 = rows.find((r) => r.kodeAkun === "5324");
  const kode5325 = rows.find((r) => r.kodeAkun === "5325");
  const kode5400 = rows.find((r) => r.kodeAkun === "5400");
  const kode4153 = rows.find((r) => r.kodeAkun === "4153");
  const kode4154 = rows.find((r) => r.kodeAkun === "4154");
  const kode4155 = rows.find((r) => r.kodeAkun === "4155");
  const kode4156 = rows.find((r) => r.kodeAkun === "4156");
  const kode4600 = rows.find((r) => r.kodeAkun === "4600");
  const kode5500 = rows.find((r) => r.kodeAkun === "5500");
  ...
  if (
    ...
    kolomJumlah.forEach((key) => {
      kode4800[key] =
        ...
        toNumber(kode5324[key]) -
        toNumber(kode5325[key]) -
        toNumber(kode5400[key]) +
        toNumber(kode4153[key]) +
        toNumber(kode4154[key]) +
        toNumber(kode4155[key]) +
        toNumber(kode4156[key]) +

...
export function hitungSubtotal4300(rows) {
  ...
  if (kode4300 && kode4001 && kode4013 && kode4026 && kode4101 && kode4071 && kode5020) {
...
export function hitungSubtotal4600(rows) {
  ...
  if (kode4600 && kode4511 && kode4501 && kode4599) {
    const kolomJumlah = ["nilaiKomersial", "nilaiFiskal"];
    kolomJumlah.forEach((key) => {
      kode4600[key] = toNumber(kode4511[key]) + toNumber(kode4501[key]) + toNumber(kode4599[key]);
    });
  }
}

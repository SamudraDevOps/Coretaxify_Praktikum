...
import LaporanLabaRugi from "@badanSections/Lampiran1/Lampiran1G/BagianA";
import Neraca from "@badanSections/Lampiran1/Lampiran1G/BagianB";

const Lampiran1G = ({ data }) => {

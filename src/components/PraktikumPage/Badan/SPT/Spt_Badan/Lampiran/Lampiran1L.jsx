...
import LaporanLabaRugi from "@badanSections/Lampiran1/Lampiran1L/BagianA";
import Neraca from "@badanSections/Lampiran1/Lampiran1L/BagianB";

const Lampiran1L = ({ data }) => {

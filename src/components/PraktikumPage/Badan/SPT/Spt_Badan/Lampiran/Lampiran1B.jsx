...
import LaporanLabaRugi from "@badanSections/Lampiran1/Lampiran1B/BagianA";
import Neraca from "@badanSections/Lampiran1/Lampiran1B/BagianB";

const Lampiran1B = ({ data }) => {

...
export default function Lampiran2Section({ sourceData }) {
  ...
  const columnGroups = [
    ...
    },
    {
      ...
      children: [
        { key: "dividen", title: "", width: 180, align: "right", render: (r) => fmtRp(r.dividen) },
      ],
    },
  ];
          ...
          <div className="flex">
            <div className="flex-1">
              <div
                className="grid"
                style={{
                  gridTemplateColumns: "52px 48px 240px 320px 120px 160px 140px 140px 80px 180px",
                }}
              >
      ...
      <ShareholderModal
        ...
        onSave={(payload) => {
          setRows((prev) => [
            ...
            {
              ...payload,
              kodeNegara: payload.kodeNegara === "IDN" ? "Indonesia" : payload.kodeNegara,
            },
          ]);

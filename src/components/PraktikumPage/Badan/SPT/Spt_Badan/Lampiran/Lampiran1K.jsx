...
import LaporanLabaRugi from "@badanSections/Lampiran1/Lampiran1K/BagianA";
import Neraca from "@badanSections/Lampiran1/Lampiran1K/BagianB";

const Lampiran1K = ({ data }) => {

...
import LaporanLabaRugi from "@badanSections/Lampiran1/Lampiran1H/BagianA";
import Neraca from "@badanSections/Lampiran1/Lampiran1H/BagianB";

const Lampiran1H = ({ data }) => {

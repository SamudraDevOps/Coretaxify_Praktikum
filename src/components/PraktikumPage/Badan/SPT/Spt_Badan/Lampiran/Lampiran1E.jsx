...
import LaporanLabaRugi from "@badanSections/Lampiran1/Lampiran1E/BagianA";
import Neraca from "@badanSections/Lampiran1/Lampiran1E/BagianB";

const Lampiran1E = ({ data }) => {

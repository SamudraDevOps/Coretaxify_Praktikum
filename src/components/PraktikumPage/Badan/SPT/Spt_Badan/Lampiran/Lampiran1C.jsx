...
import LaporanLabaRugi from "@badanSections/Lampiran1/Lampiran1C/BagianA";
import Neraca from "@badanSections/Lampiran1/Lampiran1C/BagianB";

const Lampiran1C = ({ data }) => {

                        ...
                        <tr className="border-b">
                          ...
                          <td className="p-2">
                            <input
                              // type="number"
                              className="w-full p-1 border rounded-md text-right text-sm bg-gray-100"
                              value={formatRupiah(data.detail_spt.cl_6a_ppnbm)}
                              disabled
                              name="cl_6a_ppnbm"
                            />
                          </td>
                        ...
                        <tr className="border-b">
                          ...
                          <td className="p-2">
                            <input
                              // type="number"
                              className="w-full p-1 border rounded-md text-right text-sm bg-gray-100"
                              value={formatRupiah(data.detail_spt.cl_6c_ppnbm)}
                              disabled
                              name="cl_6c_ppnbm"
                            />
                          </td>
                        ...
                        <tr className="border-b">
                          ...
                          <td className="p-2">
                            <input
                              // type="number"
                              className="w-full p-1 border rounded-md text-right text-sm BG-gray-100"
                              value={formatRupiah(data.detail_spt.cl_6e_ppnbm)}
                              disabled
                              name="cl_6e_ppnbm"
                              readOnly
                            />

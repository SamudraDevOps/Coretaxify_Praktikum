        ...
        <table className="table-auto text-sm text-left border overflow-hidden">
          <thead className="bg-purple-700 text-white text-center">
            <tr>
              ...
              <th className="p-2 border-b min-w-[220px]">Deskripsi</th>
              ...
              <th className="p-2 border-b min-w-[200px]">Bukti Kepemilikan</th>
              <th className="p-2 border-b min-w-[200px]">Informasi Tambahan</th>

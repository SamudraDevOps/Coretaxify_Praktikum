...
export default function PenghasilanLuarNegeri({ config }) {
  ...
  const columnGroups = [
    ...
    { key: "namaPemberi", title: "NAMA PEMBERI PENGHASILAN", width: 220 },
    { key: "negara", title: "NAMA NEGARA", width: 180 },
    {
  ...
  return (
    <div className="space-y-4">
      ...
      <GlobalModal
        ...
        onClose={closeModal}
        onSave={saveData}
        title={editingId ? "Edit Penghasilan Luar Negeri" : "Tambah Penghasilan Luar Negeri"}

...
export default function DaftarPiutang({ config }) {
  ...
  const columnGroups = [
    ...
    { key: "lokasipenerima", title: "Lokasi Penerima", width: 200 },

    { key: "nomoridentitas", title: "Nomor Identitas", width: 180 },

    { key: "penerimaPinjaman", title: "Nama Penerima", width: 220 },

...
import ModalPenghasilanNeto from "@lampiran/Lampiran3B/RekapitulasiPenghasilanNeto/form/ModalPenghasilanNeto";
import { buildSchema } from "@lampiran/Lampiran3B/RekapitulasiPenghasilanNeto/form/schemas";
import { updateTotalRow } from "@lampiran/Lampiran3B/RekapitulasiPenghasilanNeto/form/helper";
...
export default function BagianB() {
  ...
  return (
    <>
      <RekapitulasiPenghasilanNeto rows={rows} openModal={openModal} />
      <ModalPenghasilanNeto
        open={open}
        onClose={closeModal}

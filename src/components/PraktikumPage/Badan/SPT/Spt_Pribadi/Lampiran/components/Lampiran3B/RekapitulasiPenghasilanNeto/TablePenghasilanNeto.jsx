...
import { BULAN_NAMES, BULAN_FIELDS, KODE_JENIS_USAHA, isFieldReadonly } from "./form/schemas";

export default function TablePajakPengusaha({ rows = [], onEdit }) {
  ...
  // Helper untuk mendapatkan label dari kodeJenisUsaha bukan dari value bang
  const getJenisUsahaLabel = (value) => {
    const jenisUsaha = KODE_JENIS_USAHA.find((opt) => opt.value === value);
    return jenisUsaha ? jenisUsaha.label : "-";
  };
      ...
      <table className="min-w-full text-sm border-collapse">
        ...
        <thead className="bg-purple-700 text-white font-semibold text-center">
          <tr>
            ...
            <th className="border p-2 text-center min-w-[150px]">JENIS USAHA</th>
            ...
            return (
              <tr key={r.id} className="border-b hover:bg-gray-50">
                ...
                <td className="border p-2 text-center font-medium">
                  {getJenisUsahaLabel(r.kodeJenisUsaha)}
                </td>

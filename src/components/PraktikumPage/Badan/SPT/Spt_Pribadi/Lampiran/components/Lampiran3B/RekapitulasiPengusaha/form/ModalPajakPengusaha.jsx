...
import FormFieldPajakPengusaha from "./FormFieldPajakPengusaha";

export default function ModalPajakPengusaha({ open, onClose, title, schema, initialData, onSubmit }) {
  if (!open) return null;

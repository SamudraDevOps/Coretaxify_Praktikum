...
const BP26PDF = ({ data = {}, kopImage: kopImageProp, qrImage: qrImageProp}) => {
  ...
  const rincian = Array.isArray(bupotData.rincian) && bupotData.rincian.length
    ...
    : [{
      ...
      persentase_penghasilan_bersih: bupotData.persentase_penghasilan_bersih ?? 0,
    ...
    <Document>
      <Page size="A4" style={styles.page} wrap>
        ...
        <View style={{ flexDirection: "row" }}>
            ...
            <View style={{ flex: 1 }}>
            <RowField label="A.8 KITAS/KITAB Number" value={bupotData.nomor_kitas_kita_akun || "-"} />
            </View>
        </View>
        </View>
        ...
        <Text style={styles.mt6}>Certificate of Domicile Receipt Number :</Text>
